...
public class CentroControl {
    ...
    static {
        try { writer = new PrintWriter(new FileWriter(ARCHIVO, false), true); } catch (IOException e) { writer = null; System.err.println("CentroControl: no se pudo abrir archivo de log"); }
    }
